	...
	<div class="container-fluid" style = "padding-left: 30px; padding-right: 30px;">
		...
		<div class ="row">
			<div class = "col-md-6" style="padding-top: 20px; padding-bottom: 20px;">
				<a href = "createuser.php" ><button class = "btn-create" style="background-color: #21dd97; border:0px; border-radius: 5px; height: 100%">Create User</button></a>
				<a href = "listuser.php" ><button class = "btn-create" style="background-color: #21dd97; border:0px; border-radius: 5px; height: 100%">List User</button></a>
			</div>
		...
		<div class ="row">
			<div class = "col" style="padding-top: 40px; padding-bottom: 20px; height: 110px">
				<a href = "listinvoiceofadmin.php"><button class = "btn-create" style="background-color: #219bdd; border:0px; border-radius: 5px; height: 100%">Danh sách tất cả các phiếu xuất kho</button></a>
			</div>
		</div>
